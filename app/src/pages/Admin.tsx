        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-3 shadow-sm md:p-5">
          <div className="mb-4 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => setShowAdd(true)}
                className="rounded-xl bg-purple-600 px-3 py-1.5 font-bold text-white shadow-sm hover:bg-purple-700 text-xs flex items-center gap-1"
              >
                <i className="ph-bold ph-plus"></i> {t("addProduct")}
              </button>
            </div>
              ...
              return (
                <div key={product.id} className="grid gap-3 border-t border-slate-200 px-4 py-3 md:grid-cols-[1.2fr_1.2fr_1.5fr_1fr_1fr] md:items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      className="rounded-lg border border-red-200 bg-red-50 px-2.5 py-1.5 text-xs font-bold text-red-600 hover:bg-red-100"
                      onClick={() => {
