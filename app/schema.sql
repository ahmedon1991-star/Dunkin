-- =============================================================================
-- DATABASE SCHEMA: Branches & Employees Management System
...
-- Create RLS Policies
CREATE POLICY "Allow public select on active branches" ON branches
  FOR SELECT USING (is_active = true);

CREATE POLICY "Allow public access on employees" ON employees
  FOR ALL USING (true) WITH CHECK (true);

CREATE POLICY "Allow public access on branches" ON branches
  FOR ALL USING (true) WITH CHECK (true);
...
-- Function 1: Register New Employee (register_employee)
...
BEGIN
  ...
  -- Check Branch Existence and Activity
...
-- Function 2: Fast Employee Login (fast_employee_login)
